...
//
//	mockgen -source=helpers.go -destination=../../tests/mocks/mocks_postgres.go -package=mocks
//
...
import (
	...
	postgres "github.com/modulix-systems/goose-talk/pkg/postgres"
...
func (m *MockSupportsAcquire) Acquire(ctx context.Context) (postgres.Queryable, error) {
	m.ctrl.T.Helper()
